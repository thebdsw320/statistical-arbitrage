...
rounding_ticker_1 = int(data['roundingTicker1'])
rounding_ticker_2 = int(data['roundingTicker2'])
quantity_rounding_ticker_1 = int(data['quantityRoundingTicker1'])
quantity_rounding_ticker_2 = int(data['quantityRoundingTicker2'])
...
def get_trade_details(orderbook, direction="Long", capital=0):
    ...
    if orderbook:
        ...
        # Set price rounding
        price_rounding = rounding_ticker_1 if orderbook[0]["symbol"] == ticker1 else rounding_ticker_2
        quantity_rounding = quantity_rounding_ticker_1 if orderbook[0]["symbol"] == ticker1 else quantity_rounding_ticker_2
